...
output_axi_t out[4])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<32> *out_data_pc_buffer = new sc_bv<32>[4];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_data
				{
					...
					// {
						...
						// {
							sc_lv<32>* out_data_lv0_0_3_1 = new sc_lv<32>[4];
						// }
					// }
					...
					// bitslice(31, 0)
					{
						...
						// celement: out.data(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 3; i_0 += 1)
							{
								...
								{
									out_data_lv0_0_3_1[hls_map_index].range(31, 0) = sc_bv<32>(out_data_pc_buffer[hls_map_index].range(31, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(31, 0)
					{
						...
						// celement: out.data(31, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 3; i_0 += 1)
							{
								...
								// output_type_conversion : (out_data_lv0_0_3_1[hls_map_index]).to_uint64()
								if (&(out[0].data) != NULL) // check the null address if the c port is array or others
								{
									*(int*)&out[i_0].data = (out_data_lv0_0_3_1[hls_map_index]).to_uint64();
									hls_map_index++;
								}
							}
						}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			sc_bv<1> *out_last_V_pc_buffer = new sc_bv<1>[4];
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_last_V
				{
					...
					// {
						...
						// {
							sc_lv<1>* out_last_V_lv0_0_3_1 = new sc_lv<1>[4];
						// }
					// }
					...
					// bitslice(0, 0)
					{
						...
						// celement: out.last.V(0, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 3; i_0 += 1)
							{
								...
								{
									out_last_V_lv0_0_3_1[hls_map_index].range(0, 0) = sc_bv<1>(out_last_V_pc_buffer[hls_map_index].range(0, 0));
									hls_map_index++;
								}
							}
						}
					...
					// bitslice(0, 0)
					{
						...
						// celement: out.last.V(0, 0)
						{
							...
							for (int i_0 = 0; i_0 <= 3; i_0 += 1)
							{
								...
								// output_type_conversion : (out_last_V_lv0_0_3_1[hls_map_index]).to_string(SC_BIN).c_str()
								if (&(out[0].last) != NULL) // check the null address if the c port is array or others
								{
									out[i_0].last = (out_last_V_lv0_0_3_1[hls_map_index]).to_string(SC_BIN).c_str();
									hls_map_index++;
								}
							}
						}
	...
	else
	{
		...
		sc_bv<32>* in_data_tvin_wrapc_buffer = new sc_bv<32>[16];
		...
		tcl_file.set_num(16, &tcl_file.in_data_depth);
		...
		sc_bv<1>* in_last_V_tvin_wrapc_buffer = new sc_bv<1>[16];
		...
		tcl_file.set_num(16, &tcl_file.in_last_V_depth);
		...
		sc_bv<32>* out_data_tvin_wrapc_buffer = new sc_bv<32>[4];
		...
		tcl_file.set_num(4, &tcl_file.out_data_depth);
		...
		sc_bv<1>* out_last_V_tvin_wrapc_buffer = new sc_bv<1>[4];
		...
		tcl_file.set_num(4, &tcl_file.out_last_V_depth);
...
// [call_c_dut] ---------->
		...
		sc_bv<32>* out_data_tvout_wrapc_buffer = new sc_bv<32>[4];
		...
		sc_bv<1>* out_last_V_tvout_wrapc_buffer = new sc_bv<1>[4];
